...
| Control and validation adapters: the alignment arm (sycophantic, obsequious, power_seeking, corrigible; own and shared prompts), the hole words (cavalier, blase, insouciant), the ten Big Five factor adapters, the three probes, the rank sweep (15 traits at r 1, 4, 16), the sliders, the sycophancy / Dolci-flag / emergent-misalignment / optimised-data training arms and the three matched null zoos (shuffled 100, permuted 100, second seed 40) | Hugging Face model repo [EternalRecursion/persona-lora-zoo-qwen35-controls](https://huggingface.co/EternalRecursion/persona-lora-zoo-qwen35-controls) | public since 2026-09-16; 353 adapters, 1,374 files, 162.57 GB; manifest `qwen35/analysis/hf_controls_manifest.json`; uploader `qwen35/upload_controls_batched.py` |
| The reward-hack training arms, the unmatched first null run, the seed-1 stage-two adapters and the four pilot traits | on request from the author | they live on the Modal volumes named in `docs/REPRODUCE.md` |
